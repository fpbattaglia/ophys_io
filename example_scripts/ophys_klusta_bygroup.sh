...
cp /home/battaglia/batch_out/${OUTFILE} klusta${GROUP}/klusta${GROUP}.sgeout
rsync -avh -e ssh klusta${GROUP}/klusta${GROUP}.sgeout $REMOTE_DEST/${EXPERIMENT}/${ANIMAL}/${DATASET}/klusta${GROUP}/